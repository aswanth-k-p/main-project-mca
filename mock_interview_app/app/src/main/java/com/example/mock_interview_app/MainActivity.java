                ...
                if (uname.equalsIgnoreCase("")) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (status.equalsIgnoreCase("success")) {
                                    ...
                                    String nm = jo.getString("nm");

                                    SharedPreferences.Editor edt = sh.edit();
                                    edt.putString("lid", lid);
                                    edt.putString("type", jo.getString("type"));
                                    edt.commit();
                                    ...
                                    if(type.equalsIgnoreCase("user"))
                                    {
                                        ...
                                        startActivity(in);
                                        Toast.makeText(MainActivity.this, "WELCOME "+nm, Toast.LENGTH_SHORT).show();
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(MainActivity.this, error+" errrrrrrr", Toast.LENGTH_SHORT).show();
                        }
                    }) {
                        @Override
